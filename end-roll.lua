{
	Tools = ordered() {
		...
		MediaIn_logo = MediaIn {
			NameSet = true,
			CustomData = { MediaProps = { MEDIA_NUM_LAYERS = 0, MEDIA_FORMAT_TYPE = "PNG", MEDIA_NAME = "logo_r.png", MEDIA_LAYER_DESC = {
					}, MEDIA_PAR = 1, MEDIA_HEIGHT = 1980, MEDIA_START_FRAME = 0, MEDIA_IS_SOURCE_RES = true, MEDIA_SRC_FRAME_RATE = 60, MEDIA_MARK_OUT = 0, MEDIA_WIDTH = 1980, MEDIA_NUM_FRAMES = 1, MEDIA_MARK_IN = 0, MEDIA_PATH = "" } },
			Inputs = {
		...
		temolate = TextPlus {
			...
			Inputs = {
				...
				Tab1Position = Input { Value = -0.0264516129032258, },
		...
		instagramLogo = MediaIn {
			NameSet = true,
			CustomData = { MediaProps = { MEDIA_NUM_LAYERS = 0, MEDIA_FORMAT_TYPE = "PNG", MEDIA_NAME = "instagram.png", MEDIA_LAYER_DESC = {
					}, MEDIA_PAR = 1, MEDIA_HEIGHT = 1080, MEDIA_START_FRAME = 0, MEDIA_IS_SOURCE_RES = true, MEDIA_SRC_FRAME_RATE = 60, MEDIA_MARK_OUT = 0, MEDIA_WIDTH = 1080, MEDIA_NUM_FRAMES = 1, MEDIA_MARK_IN = 0, MEDIA_PATH = "" }, },
			Inputs = {
				EffectMask = Input {
					SourceOp = "instaRect",
					Source = "Mask",
		...
		twitterLogo = MediaIn {
			NameSet = true,
			CustomData = { MediaProps = { MEDIA_NUM_LAYERS = 0, MEDIA_FORMAT_TYPE = "PNG", MEDIA_NAME = "twitter.png", MEDIA_LAYER_DESC = {
					}, MEDIA_PAR = 1, MEDIA_HEIGHT = 1080, MEDIA_START_FRAME = 0, MEDIA_IS_SOURCE_RES = true, MEDIA_SRC_FRAME_RATE = 60, MEDIA_MARK_OUT = 0, MEDIA_WIDTH = 1080, MEDIA_NUM_FRAMES = 1, MEDIA_MARK_IN = 0, MEDIA_PATH = "" } },
			Inputs = {
				EffectMask = Input {
